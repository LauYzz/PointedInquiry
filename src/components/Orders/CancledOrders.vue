<template>
  <div>
    <div>
      <el-card :body-style="{ padding: '0px' }" v-if="orders[index].state == '已取消'" v-for="(item, index) in orders"
        :key="index">
        ...
        'state4': orders[index].state === '已取消',
          ...
          <div class="description">
            ...
            <div class="btns">
              <el-button @click="getExpert(item, index)"
                style="padding-left: 12px;padding-right: 12px;">查看行家</el-button>
