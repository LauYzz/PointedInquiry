<template>
  <div class="bg">
    ...
    <div class="icons">
      <span class="com" :class="{active: selectedType === 1}" @click="changeView(1)">
      ...
      <span class="com" :class="{active: selectedType === 3}" @click="changeView(3)">
    ...
    <el-card :body-style="{ padding: '0px' }" v-for="(item, index) in Experts" :key="index">
      <div style="padding: 14px;" @click="linkToExpertDetail(item, index)">
        ...
        <div class="description">
          <div class="subdes">
            <span class="topic" v-for="(subItem, subIndex) in item.topics" :key="subIndex">
              <i style="color:white; font-size: 20px;">#&nbsp;</i>{{ subItem.title }}
