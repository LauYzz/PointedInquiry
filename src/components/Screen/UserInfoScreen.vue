  ...
  <el-container>
    ...
    <el-container>
      <el-main style="height:710px;">
        ...
        <span @click="linkToUserInfo()" class="sub"><i class="iconfont icon-person"></i>我的信息 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
        <span @click="linkToMyCollection()" class="sub"><i class="iconfont icon-check"></i>我的收藏 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
        <span @click="linkToExpertApplicationPage()" class="sub"><i class="iconfont icon-person_add"></i>成为行家 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
        <el-dialog title="提交信息" :visible.sync="dialogVisible" width="95%" :before-close="handleClose">
          <getQualification />
        </el-dialog>
        <span @click="MyExpertInfo" class="sub"><i class="iconfont icon-contacts"></i>我的行家信息 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
        <span class="sub" @click="linkToAboutUs()"><i class="iconfont icon-more_horiz"></i>关于我们 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
        <el-dialog :visible.sync="NotExpertVisible" width="95%" :before-close="handleClose">
        ...
        <el-dialog :visible.sync="HaveExpertVisible" width="95%" :before-close="handleClose">
          <div style="text-align:center">
            <span style="font-size:18px;">您已经是行家了！</span>
          </div>
        </el-dialog>
        <span class="sub" @click="linkToSpecialNotice()"><i class="iconfont icon-info"></i>特别声明 <i
            class="iconfont icon-keyboard_arrow_right"></i></span>
      </el-main>
    </el-container>
